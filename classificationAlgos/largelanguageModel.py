...
class GeminiModel:
    def __init__(self, api_key, batch_size, delay = None, model_name="gemini-2.0-flash"):
        """
        """
        self.api_key = api_key
        self.batch_size = batch_size
        self.model_name = model_name
        self.delay = delay if delay is not None else 6
        self.cache = {}
    ...
    def _generate(self, prompt):
        ...
        time.sleep(self.delay)  # Rate limit management
